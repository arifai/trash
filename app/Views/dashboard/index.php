                            ...
                            <div class="card-body">
                                ...
                                <div class="direct-chat-contacts">
                                    <ul class="contacts-list">
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img" src="<?= base_url('dist/img/user1-128x128.jpg') ?>">
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img" src="<?= base_url('dist/img/user7-128x128.jpg') ?>">
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img" src="<?= base_url('dist/img/user3-128x128.jpg') ?>">
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img" src="<?= base_url('dist/img/user5-128x128.jpg') ?>">
